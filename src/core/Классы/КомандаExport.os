...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	Парсер.ДобавитьИменованныйПараметрКоманды(ОписаниеКоманды, "-temp-db-connection-string", "<Строка соединения временной базы>");
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры) Экспорт
	...
	СтрокаСоединенияВременнойБазы = ПараметрыКоманды["-temp-db-connection-string"];
