...
Перем мСтрокаСоединенияВременнойБазы;
Перем ЭтоWindows;
...
Функция ПолучитьМенеджерКонфигуратора()
	...
	Если ЗначениеЗаполнено(мСтрокаСоединенияВременнойБазы) Тогда
		Конфигуратор.УстановитьКонтекст(мСтрокаСоединенияВременнойБазы, "", "");
	Иначе
...
Процедура УстановитьСтрокуСоединенияВременнойБазы(СтрокаСоединенияВременнойБазы = Неопределено) Экспорт
	мСтрокаСоединенияВременнойБазы = СтрокаСоединенияВременнойБазы;
КонецПроцедуры
